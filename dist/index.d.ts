...
export declare type FontType = "helvetica" | "times" | "courier";
export declare type HAlignType = "left" | "center" | "right" | "justify";
export declare type VAlignType = "top" | "middle" | "bottom";
export declare type OverflowType = "linebreak" | "ellipsize" | "visible" | "hidden" | ((text: string | string[], width: number) => string | string[]);
export declare type CellWidthType = "auto" | "wrap" | number;
...
export declare type ThemeType = "striped" | "grid" | "plain" | null;
export declare type PageBreakType = "auto" | "avoid" | "always";
export declare type RowPageBreakType = "auto" | "avoid";
export declare type TableWidthType = "auto" | "wrap" | number;
export declare type ShowHeadType = "everyPage" | "firstPage" | "never" | boolean;
export declare type ShowFootType = "everyPage" | "lastPage" | "never" | boolean;
